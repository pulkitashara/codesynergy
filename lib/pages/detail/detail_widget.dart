            ...
            children: [
              StreamBuilder<List<TodoRecord>>(
                ...
                builder: (context, snapshot) {
                  ...
                  List<TodoRecord> containerTodoRecordList = snapshot.data!;
                  // Return an empty Container when the item does not exist.
                  if (snapshot.data!.isEmpty) {
                    return Container();
                  }
                  final containerTodoRecord = containerTodoRecordList.isNotEmpty
                      ? containerTodoRecordList.first
                      : null;
                  return Container(
                    width: 394.0,
                    height: 857.0,
                    ...
                    child: Stack(
                      children: [
                        ...
                        Align(
                          alignment: AlignmentDirectional(-0.73, -0.63),
                          child: Text(
                            containerTodoRecord!.desp,
                            style: FlutterFlowTheme.of(context)
                                .bodyMedium
                                .override(
                                  fontFamily: 'Readex Pro',
